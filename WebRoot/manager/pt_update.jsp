                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%" border="1">
                                    <tr>
                                        <td colspan="2">
                                            <form target="_parent"  action="updateptProducttype.action" enctype="multipart/form-data" name="updatesuccess" method="post">
                                                <table width="100%"class="cont">
                                                  ...
                                                  <tr align="center" class="d" >
                                                 	<td>
	                                                     <img style="width: 55px;height: 40px" src="images/${producttype.ptImg}" alt="">
	                                                        <input type="file" name="image" value="${producttype.ptImg}" /> 
                                                     </td>
                                                        	
                                                        <td>
                                                            <select name="ppid">
                                                   				<c:forEach var="type" items="${producttypeList}">
                                                                	<option value="${type.ptId}" <c:if test="${type.ptId == producttype.ptId}">selected="selected"</c:if> >${type.ptName}</option>
                                                    			</c:forEach>
                                                             </select>
                                                        </td> 
                                                ...
                                                <input type="hidden" name="producttype.ptId" value="${producttype.ptId}">
