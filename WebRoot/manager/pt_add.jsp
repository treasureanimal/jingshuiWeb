                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="addptProducttype.action" enctype="multipart/form-data" name="addptsuccess" method="post">
                                                <table width="100%"class="cont">
                                                     <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td width="15%">产品类型名称：</td>
                                                        <td width="25%"><input class="text" type="text" name="producttype.ptName" /></td>
                                                        <td>添加产品类型名称</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                      				 <tr>
