    ...
    <div class="case_main index_public">
        <section class="case_left">
            ...
            <ul class="case_left_ul1">
                <li><a href="findNews.action"  class="case_left_li_on">公司新闻</a></li>
                <li><a href="fenyehangyedongtaiHydt.action" class="case_left_li_on">行业动态</a></li>
                <li><a href="">常见问题</a></li>
            </ul>
        ...
        <section class="case_right">
            <header class="case_right_f">
                <div class="case_right_f_l">行业动态</div>
                <div class="case_right_f_r">
                    <a href="toIndexIndexAction.action">首页</a>&gt
                    <a href="fenyehangyedongtaiHydt.action">行业动态</a>&gt
            ...
            <div class="case_right_box"><!--
                ...
                -->
                  ...
                  <c:forEach var="hydt" items="${hydtList}">
                    <section class="news-list">
                    <a href=""><img src="images/${hydt.HImg}" alt=""></a>
                    <dl>
                        <dt>${hydt.HTitle}</dt>
                        <dd class="news-list_dd1">
                            <img src="images/news_10 (2).png" alt="" class="news-list_d1_i1">
                           <span><fmt:formatDate value="${hydt.HDate}" type="date"/></span>
                            <img src="images/news_10 (1).png" alt="" class="news-list_d1_12">
                            <span>人看过</span>
                        </dd>
                        <dd class="news-list_dd2">${hydt.HContent} <a href="findhydtByIdHydt.action?id=${hydt.HId}" class="news-list_dd2_a">[查看详情]</a></dd>
                    </dl>
                    <div class="clear"></div>
            ...
            <div class="page">
                <a href="fenyehangyedongtaiHydt.action?nowpage=1">首页</a>
                <a href="fenyehangyedongtaiHydt.action?nowpage=${backpage}">上一页</a>
                <a href="fenyehangyedongtaiHydt.action?nowpage=${nextpage}">下一页</a>
                <a href="fenyehangyedongtaiHydt.action?nowpage=${pages}">末页</a>
