...
<html>
  <head>
    ...
    <title>My JSP 'case_show.jsp' starting page</title>
        ...
        <section class="case_right">
            ...
            <div class="case_right_box">
                ...
                <dl class="case_right_dl">
                    <dt><a href="findproductcaseByPcIdProductcase.action?pcid=${productcase.pcId}"><img src="images/anli/${productcase.pcImg}" /></a></dt>
                    <dd><a href="findproductcaseByPcIdProductcase.action?pcid=${productcase.pcId}" target="_blank">${productcase.pcName}</a></dd>
                </dl>
                    </c:forEach>
                <div class="clear"></div>
            </div>
               <div class="page">
				  <A href="findproductcaseProductcase.action?nowpage=1">首页</A>
				  <A href="findproductcaseProductcase.action?nowpage=${backpage}">上一页</A>
				  <A href="findproductcaseProductcase.action?nowpage=${nextpage}">下一页</A>
				  <A href="findproductcaseProductcase.action?nowpage=${pages}">末页</A>
