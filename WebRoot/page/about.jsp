...
<html>
  ...
  <body>
    ...
    <div class="case_main index_public">
        <section class="case_left">
            ...
            <ul class="case_left_ul1">
                <li><a href="findcompanygsjjCompany.action" class="case_left_li_on">公司简介</a></li>
                <li><a href="findcompanylxwmCompany.action">关于我们</a></li>
                <li><a href="findcompanygywmCompany.action">发展历程</a></li>
                <li><a href="page/fzlc.jsp">认证执照</a></li>
            </ul>
        ...
        <section class="case_right">
            <header class="case_right_f">
                <div class="case_right_f_l">发展历程</div>
   ...
   威可利凭借专业自主的研发系统，凭其过硬的品质与完善的售后服务，深受广大客户的好评，并先后获得数十项国家发明专利与实用专利技术、ISO9001:2008质量体系认证，ISO14001：2004环境管理体系认证，OHSAS18001职业安全管理体系认证 ，节能环保产品认证，CQC产品质量认证，CE安全资质认证、IP44外壳防护、卫生安全产品卫生许可批件等一系列认证。通过并获得中国开水机行业十大品牌、质量·服务·信誉3A企业、国家工业生产许可权威企业，并获得企业最高信誉级别“3A级信用企业”。
                </div>
